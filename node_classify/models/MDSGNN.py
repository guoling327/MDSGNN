...
class FourierEncoding2(nn.Module):
    def __init__(self, hidden_dim=128):
        super( FourierEncoding2, self).__init__()
        self.constant = 100
        self.hidden_dim = hidden_dim
        self.eig_w = nn.Linear(hidden_dim+1, 1)
...
class MDSGNN(nn.Module):
    ...
    def __init__(self,dataset, args):
        ...
        self.layers = nn.ModuleList([MDSGNNLayer(2, args.hidden, args.dprate) for i in range(args.nlayer)])
