...
def my_args(args):
    args += ['--model', 'MDSGNN_gin']  # sparse_cin, MDSGNN_gin
    args += ['--petalType', "simplex"]  # simplex,ring
    args += ['--max_petal_dim', "2"]
    args += ['--exp_name', 'MDSGNN']  # 1:mpsn-redditb,2:MDSGNN-NCI1,3:gin-NCI1 4:MDSGNN-MUTAG 5:MDSGNN-PTC, 6:MDSGNN-NCI109
    args += ['--dataset',
...
def mpsn_args(args):
    args += ['--model', 'sparse_cin']  # sparse_cin, MDSGNN_gin
    args += ['--petalType', "simplex"]  # simplex,ring
    args += ['--max_petal_dim', "2"]
    args += ['--exp_name',
             'MPSN-MUTAG']  # 1:mpsn-redditb,2:MDSGNN-NCI1,3:gin-NCI1 4:MDSGNN-MUTAG 5:MDSGNN-PTC, 6:MDSGNN-NCI109
    args += ['--dataset',
...
def COLLAB_args(args):
    ...
    args += ['--max_petal_dim', "2"]
    args += ['--exp_name',
             'MDSGNN_gin']  # 1:mpsn-redditb,2:MDSGNN-NCI1,3:gin-NCI1 4:MDSGNN-MUTAG 5:MDSGNN-PTC, 6:MDSGNN-NCI109
    args += ['--dataset',
